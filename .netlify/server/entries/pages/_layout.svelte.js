  ...
  return ` ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-1pxte21">HOME</a> <a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-1393pt7">INDUCTEES</a> <a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-9rzrwf">EVENTS</a> <a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-11183la">MEDIA</a> <a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-1htus5n">DONATE</a> <a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-d2bbpk">IMPACT</a> <a class="no-underline hover:underline" target="_blank" rel="noreferrer" data-svelte-h="svelte-18eu4hh">ABOUT</a> <img src="/logos/insta.png" alt="facebook"> <img src="/logos/twitter-16.png" alt="facebook"> <img src="/logos/facebook-16.png" alt="facebook"> <img src="/logos/youtube.png" alt="facebook"> <img src="/logos/linkedin-16.png" alt="facebook"> `;
        },
        lead: () => {
          return `<img src="/logos/ahflogos5.png" alt="logo">`;
        }
      })} `;
    },
    default: () => {
